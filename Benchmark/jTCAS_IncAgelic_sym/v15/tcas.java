public class tcas {
	...
	public static int MINSEP=650; //error:  MINSEP=300;
	 ...
	 int alt_sep_test()
	{
	    ...
	    enabled = High_Confidence && (Own_Tracked_Alt_Rate <= OLEV); //error: enabled = High_Confidence && (Own_Tracked_Alt_Rate <= OLEV) && (Cur_Vertical_Sep > MAXALTDIFF);
