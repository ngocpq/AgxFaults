public class tcas {
	 ...
	 boolean Non_Crossing_Biased_Climb()
	{
		...
		result = ((Own_Below_Threat()) && (!(Down_Separation >= ALIM()))); //error: result = !(Own_Below_Threat()) || ((Own_Below_Threat()) && (!(Down_Separation >= ALIM()))); 
	    }
	    else
	    {	
	 ...
	 int alt_sep_test()
	{
	    ...
	    {
		need_upward_RA = Non_Crossing_Biased_Climb(); //error: need_upward_RA = Non_Crossing_Biased_Climb() && Own_Below_Threat();
