public class tcas {
	...
	{
	    return (Own_Tracked_Alt <= Other_Tracked_Alt); //error: return (Own_Tracked_Alt < Other_Tracked_Alt);
	}

	 boolean Own_Above_Threat()
	{
	    return (Other_Tracked_Alt <= Own_Tracked_Alt); //error: return (Other_Tracked_Alt < Own_Tracked_Alt);
	}
	 ...
	 int alt_sep_test()
	{
		...
		if (need_upward_RA) //error: if (need_upward_RA && need_downward_RA)
